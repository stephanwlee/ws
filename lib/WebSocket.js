...
function initAsClient(address, protocols, options) {
  ...
  if (options.isDefinedAndNonNull('pfx')
   ...
   || options.isDefinedAndNonNull('honorCipherOrder')) {
    ...
    if (options.isDefinedAndNonNull('honorCipherOrder')) requestOptions.honorCipherOrder = options.value.honorCipherOrder;
